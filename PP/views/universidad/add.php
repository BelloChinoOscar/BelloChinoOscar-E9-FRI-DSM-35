...
<?php
    ...
    $comporbarestado= mysqli_num_rows(mysqli_query($conexion, "SELECT Nombre FROM universidad WHERE Nombre = '$nombre'"));

    if($comporbarestado>=1){ ?>
    <br>
               <div class="alert alert-danger alert-dismissible">
                     <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        Nombre de universidad repetido
               </div>

    <?php }else{  ?> <?php
    
            $registro = "INSERT INTO universidad (Nombre) VALUES ('$nombre')";
        ...
        <br>
            <div class="alert alert-success alert-dismissible">
               ...
               <?php
                 ?>
                 <meta http-equiv="refresh" content="0;../../registroU.php">
