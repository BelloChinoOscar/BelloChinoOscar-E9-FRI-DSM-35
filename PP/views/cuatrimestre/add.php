            ...
            <div class="mb-2">
                ...
                <form method="post" >
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="Nombre" id="Nombre" placeholder="Introduzca nuevo cuatrimestre" required ">
                    </div>
                    </div>
...
<?php
    ...
    $comporbarestado= mysqli_num_rows(mysqli_query($conexion, "SELECT Nombre FROM cuatrimestre WHERE Nombre = '$nombre'"));

    if($comporbarestado>=1){ ?>
    <br>
               <div class="alert alert-danger alert-dismissible">
                     <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                        Cuatrimestre repetido
               </div>

    <?php }else{  ?> <?php
    
            $registro = "INSERT INTO cuatrimestre (Nombre) VALUES ('$nombre')";
        ...
        <br>
            <div class="alert alert-success alert-dismissible">
               ...
               <?php
                 ?>
                 <meta http-equiv="refresh" content="0;../../registroCUA.php">
